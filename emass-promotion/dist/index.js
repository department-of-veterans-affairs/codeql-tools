...
module.exports = eval("require")("node-gzip");
...
const {gzip} = __nccwpck_require__(626)
...
const {createCodeQLGitHubClient, createGitHubAppClient, createGitHubClient} = __nccwpck_require__(923)
